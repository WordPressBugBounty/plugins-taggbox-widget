		...
		<div class="__taggbox__widgetinn">
			...
			?>
					<div class="__taggbox__widgetbox <?php echo $__taggbox__active_widget_id == $__taggbox__widget->id ? 'active' : ''; ?>" id="<?php echo esc_attr('__taggbox__widgetbox' . $count); ?>">
						...
						<div class="__taggbox__widget_sourcecode" onclick="__taggbox__copyToWidgetShortCode('[taggbox widgetid=&quot;<?php echo esc_js($__taggbox__widget->id); ?>&quot;]');">
						...
						<div class="__taggbox__widgetfoot">
							<ul>
								<li><a href="javascript:void(0);" onclick="__taggbox__menus(2, '<?php echo esc_js($__taggbox__widget->id); ?>')"> Open </a></li>
								<li>
									<a href="javascript:void(0);" onclick="__taggbox__widgetEditForm('<?php echo esc_js($__taggbox__widget->id); ?>', '<?php echo esc_js($__taggbox__widget->name); ?>');">
										Rename
									</a>
								</li>
